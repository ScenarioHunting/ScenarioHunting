...
ReactDOM.render(
    <>
        <nav className="sidebar-nav">
            <Link to="/">
                <svg fill="currentColor" fillRule="nonzero" viewBox="0 0 512 512">
                    <g>
            ...
            <Link to="/template-list">
                <svg fill="currentColor" fillRule="nonzero" viewBox="0 0 32 32" >
        ...
        <svg fill="currentColor" fillRule="nonzero" style={{ paddingLeft: "13px" }} width="292" height="1" viewBox="0 0 292 1" fill="none" xmlns="http://www.w3.org/2000/svg">
