...
class templateRepository {
    ...
    private async findAllTemplateWidgets(): Promise<SDK.IWidget[]> {
        ...
        console.log("# of have metadata.clientId.testTemplate:", widgets.filter(i => i.metadata && i.metadata[miro.getClientId()] && i.metadata[miro.getClientId()]["testTemplate"]).length)
        console.log("# of have metadata.clientId.testTemplate.templateName:", widgets.filter(i => i.metadata && i.metadata[miro.getClientId()] && i.metadata[miro.getClientId()]["testTemplate"] && i.metadata[miro.getClientId()]["testTemplate"]["templateName"]).length)
