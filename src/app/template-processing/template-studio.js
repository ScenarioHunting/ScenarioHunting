...
window.setupEditor = async () => {
    ...
    //Language:
    var editorModel
    function switchEditorModel(editor, language) {
        console.log('Switching to language')
        editorModel = monaco.editor.createModel(editor.getValue(), language)
        editor.setModel(editorModel)
    }
    async function switchLanguage(language = document.getElementById("language-select").value) {
        switchEditorModel(editor, language)
    ...
    function toggleTheme() {
        ...
        if (wasDark) {
            ...
            document.getElementById('theme-button').innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="350" height="350" viewBox="0 0 350 350" xml:space="preserve">
    ...
    window.onEditorReady = async function () {
        ...
        editor.onDidChangeModelContent(() =>
            preview(document.getElementById("language-select").value, editorModel))
        toggleTheme()
        toggleTheme()
    }
