...
import { WhenTestResultsSummeryViewModel } from "test-result-reports";
...
const applyReportToWidget = async (widgetId: string, vm: WhenTestResultsSummeryViewModel) => {
	...
	singletonBoard.updateWidgetText(widgetId, newWidgetText)
}
...
miro.onReady(async () => {
	...
	ws.onmessage = function (evt) {
		...
		applyReportToWidget(evt.data.id, evt.data.testReport)
