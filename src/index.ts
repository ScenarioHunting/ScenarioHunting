...
async function makeAnExample(widgets: SDK.IWidget[]) { // accept widgets as parameter, work on te
	// const selectedWidgets  = await miro.board.selection.get()
	if (widgets.length != 1)
		return
	console.log("HEEEEEEEEEEEEEEEEEEYYYYYYYYYYYYYY!!!!!!!!!!!!!!", widgets[0])
