...
const icon24 = '<path fill="currentColor" fill-rule="nonzero" d="M 20.156 7.762 M 10 11 L 10 17 L 12.672 17.056 L 12.728 10.544 z z L 6.17 11.799 L 6.044 5.909 L 16 7 L 16 10 Z L 12.012 9.966 l -0.027 -1.274 l -1.821 -0.05 L 10.164 10.232 L 12.038 9.966 L 12.801 9.031 L 14.199 8.858 L 14.199 8.023 L 13.109 7.938 L 13.094 10.033 Z L 8.495 6.933 L 6.526 6.891 L 6.555 8.618 L 8.508 8.434 L 8.495 6.882"/>'
